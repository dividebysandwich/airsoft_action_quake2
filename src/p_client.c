                        	...
                        	switch (loc)
                                {
                                	case LOC_HDAM:                                                                  
                                        	message = " caught";
                                                if (IsNeutral(self))
                                                	message2 = "'s BB with its forehead";
                                                else if (IsFemale(self))
                                                        message2 = "'s BB with her forehead";
                                                else
                                                        message2 = "'s BB with his forehead";
                                                break;
                                        case LOC_CDAM:
                                                message = "'s jacket doesn't help against";
                                                message2 = "'s BBs";
                                                break;
                                        case LOC_SDAM:
                                               	message = " goes back to Ops thanks to";
                                                message2 = "'s HiCap rounds";
                                                break;
                                        case LOC_LDAM:
                                                if (IsNeutral(self))
                                                	message = " gets some blisters on its legs thanks to";
                                                else if (IsFemale(self))
                                                	message = " gets some blisters on its legs thanks to";
                                                else
                                                	message = " gets some blisters on its legs thanks to";
                                                message2 = "'s BB rounds";
                                                break;
                                        default:
                                                message = " was hit by";
                                                message2 = "'s 6mm BBs";
