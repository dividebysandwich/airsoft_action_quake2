...
//AQ2 END
	...
	if(self->client->pers.weapon == FindItem(GRENADE_NAME))
		...
		target[2] += ltk_skill->value;	//AIRSOFT: Aim 0 to 10 degrees higher, since BB's don't fly straight
		//(10 appears to be the ideal value, so this corresponds with the skill variable perfectly.
